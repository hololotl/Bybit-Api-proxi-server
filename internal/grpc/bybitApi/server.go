...
type ApiFunctions interface {
	FuturesTransactions(ctx context.Context, pageSize int, publicApiKey string)
...
func (serverApi *ServerApi) FuturesTransactions(ctx context.Context, in *grpcFile.FuturesTransactionsRequest) (*grpcFile.FuturesTransactionsResponse, error) {
	return nil, nil
}
